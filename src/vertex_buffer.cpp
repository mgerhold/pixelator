...
VertexBuffer::VertexBuffer(
        ...
        GLsizeiptr initialIndexBufferCapacityInBytes
) noexcept
    ...
    if (initialVertexBufferCapacityInBytes > 0LL) {
        glNamedBufferData(
                mVertexBufferObjectName,
                initialVertexBufferCapacityInBytes,
                nullptr,
    ...
    if (initialIndexBufferCapacityInBytes > 0LL) {
        glNamedBufferData(
                mElementBufferObjectName,
                initialIndexBufferCapacityInBytes,
                nullptr,
                static_cast<GLenum>(usagePattern)
        );
