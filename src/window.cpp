...
Window::Window(std::string const& title, WindowSize size, OpenGLVersion version, Input& input) noexcept
...
// clang-format off
void Window::handleOpenGLDebugOutput(
    GLenum source,
    GLenum type,
    unsigned int id,
    GLenum severity,
    GLsizei, char const* message,
    void const*
) { // clang-format on
